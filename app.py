...
with row1_col1:
    ...
    fig_map.update_layout(height=160, margin=dict(t=10, b=10), coloraxis_showscale=False)
    st.plotly_chart(fig_map, use_container_width=True)

# ----- Chart 2: HPV Vaccine Line Chart -----
with row1_col2:
    ...
    fig_line.update_layout(height=160, yaxis_range=[0, 100], margin=dict(t=10, b=10), showlegend=False)
...
with row1_col3:
    ...
    fig_pie.update_layout(height=160, margin=dict(t=10, b=10), showlegend=False)
    st.plotly_chart(fig_pie, use_container_width=True)

# ----- Chart 4: Biopsy by Age -----
with row2_col1:
    ...
    fig_biopsy.update_layout(height=160, xaxis_range=[0, 1], xaxis_tickformat=".0%", margin=dict(t=10, b=10), showlegend=False)
...
with row2_col2:
    ...
    fig_cancer.update_layout(height=160, margin=dict(t=10, b=10), showlegend=False)
    st.plotly_chart(fig_cancer, use_container_width=True)

# Optional: Use this cell for logo or notes
with row2_col3:
    st.markdown("<div style='text-align:center; font-size:12px; color:gray;'>All data © 2022 WHO/Globocan</div>", unsafe_allow_html=True)
