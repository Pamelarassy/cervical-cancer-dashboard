...
with left_col:
    ...
    with col_inc:
        ...
        <p style='color:#004B9B; font-size:22px;'>
        <b>Rank:</b> <span style='font-size:32px; font-weight:bold;'>8</span> &nbsp;&nbsp;&nbsp;&nbsp;
        <b>Cases:</b> <span style='font-size:32px; font-weight:bold;'>662,301</span>
        </p>
    ...
    with col_mort:
        ...
        <p style='color:#D7191C; font-size:22px;'>
        <b>Rank:</b> <span style='font-size:32px; font-weight:bold;'>9</span> &nbsp;&nbsp;&nbsp;&nbsp;
        <b>Deaths:</b> <span style='font-size:32px; font-weight:bold;'>348,874</span>
        </p>
        """, unsafe_allow_html=True)
...
with left_col:
    ...
    fig_line.update_layout(yaxis_range=[0, 100], height=500)
