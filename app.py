...
with col2_right:
    df_biopsy = pd.read_csv("cleaned_cervical_cancer_dataset.csv")
    df_biopsy.columns = df_biopsy.columns.str.strip().str.lower()
...
with col3_right:
    df_biopsy.columns = df_biopsy.columns.str.strip()
    hpv_positive = df_biopsy[df_biopsy['Dx:HPV'] == 1]
